...
function Food (){
    ...
    let nonvegmenu=document.getElementById("vma1").value ;
      ...
      <Stack direction="row">
        ...
        <form id="leftcon" >
          ...
          <td><b>Popular restaurents for veg</b></td>
           <p> <td><select id='vr'>
              <option type="">Select</option>
              <option type="">Hotel Ganesh Bhavan,New Delhi</option>
              <option type="">Hotel Sri Vaishnavi devi,New Delhi</option>
              <option type="">Annalakshmi Restaurent,New Delhi</option>
              <option type="">Royal Vega,New Delhi</option>
             </select ></td></p>
        ...
        <form id="rightcon">
          ...
          <td><b>Top restaurents for Non-veg</b></td>
           <p><td><select id='vra1'>
              <option type="">Select</option>
              <option type="">Almaza Restaurent,New Delhi</option>
              <option type="">Hotel Varshini,New Delhi</option>
              <option type="">Pind bulluchi restaurent,New Delhi</option>
              <option type="">Dhaba Estd,New Delhi</option>
             </select ></td></p>
