      ...
      <Stack direction="row">
        ...
        <form id="leftcon" >
          ...
          <td><b>Popular restaurents for veg</b></td>
           <p> <td><select id='vr'>
              <option type="">Select</option>
              <option type="">Saravana Bhavan,Adayar,Chennai</option>
              <option type="">Adaiyar Anandha Bhavan,Chennai</option>
              <option type="">Annalakshmi Restaurent,Chennai</option>
              <option type="">Royal Vega,Chennai</option>
             </select ></td></p>
        ...
        <form id="rightcon">
          ...
          <td><b>Top restaurents for Non-veg</b></td>
           <p><td><select id='vr1'>
              <option type="">Select</option>
              <option type="">Almaza Restaurent,Chennai</option>
              <option type="">Dakshni Hotel,Chennai</option>
              <option type="">Dindigul Thalappakatti restaurent,Chennai</option>
              <option type="">Dhaba Estd,Chennai</option>
             </select ></td></p>
