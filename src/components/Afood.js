...
function Food (){
    ...
    let vegmenu=document.getElementById("vmax").value ;
      ...
      <Stack direction="row">
        ...
        <form id="leftcon" >
          ...
          <td><b>Popular restaurents for veg</b></td>
           <p> <td><select id='vr'>
              <option type="">Select</option>
              <option type="">Hotel Ganesh Bhavan,Allahabad</option>
              <option type="">Hotel Sri Vaishnavi devi,Allahabad</option>
              <option type="">Annalakshmi Restaurent,allahabad</option>
              <option type="">Royal Vega,Allahabad</option>
             </select ></td></p>
        ...
        <form id="rightcon">
          ...
          <td><b>Top restaurents for Non-veg</b></td>
           <p><td><select id='vra1'>
              <option type="">Select</option>
              <option type="">Almaza Restaurent,Allahabad</option>
              <option type="">Hotel Varshini,Allahabad</option>
              <option type="">Pind bulluchi restaurent,Allahabad</option>
              <option type="">Dhaba Estd,Allahabad</option>
             </select ></td></p>
